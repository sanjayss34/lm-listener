...
def get_args_parser():
    ...
    parser.add_argument('--loss-aux', type=float, default=0.0, help='hyper-parameter for the velocity loss')
    parser.add_argument('--recons-loss', type=str, default='l2', help='reconstruction loss')
    parser.add_argument('--pose-alpha', type=float, default=1.0)
    ...
    parser.add_argument('--separate_pose', type=int, default=None)
    parser.add_argument('--aux_labels', type=int, default=0)
