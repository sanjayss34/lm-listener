...
def convert_vq_state_dict(state_dict):
    new_state_dict = {}
    for key in state_dict:
        new_state_dict[key.replace('encoder.model', 'encoder.0.model').replace('decoder.model', 'decoder.0.model').replace('quantizer.codebook', 'quantizer.0.codebook')] = state_dict[key]
